    ...
    public partial class FirstMG : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersPandape", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stages_Vacancies_VacancyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalVacancyId = table.Column<int>(type: "integer", nullable: false),
                    ExternalStageId = table.Column<int>(type: "integer", nullable: false),
                    ExternalMatchId = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PandapeCandidates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PandapeCandidates_Stages_StageId",
                        column: x => x.StageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PandapeCandidates_StageId",
                table: "PandapeCandidates",
                column: "StageId");
